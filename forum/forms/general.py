...
login_form_widget_attrs = { 'class': 'required login signup-text-field' }
...
class UserEmailField(forms.EmailField):
    def __init__(self,skip_clean=False,**kw):
        self.skip_clean = skip_clean
        super(UserEmailField,self).__init__(widget=forms.TextInput(attrs=dict(login_form_widget_attrs,placeholder="name@example.com",
...
class CaptchaTestForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        super(CaptchaTestForm, self).__init__(*args, **kwargs)
