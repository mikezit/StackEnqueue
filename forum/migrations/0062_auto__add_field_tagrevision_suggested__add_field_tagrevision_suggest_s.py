...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TagRevision.suggested'
        db.add_column('forum_tagrevision', 'suggested', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'TagRevision.suggest_status'
        db.add_column('forum_tagrevision', 'suggest_status', self.gf('django.db.models.fields.CharField')(default='', max_length=16), keep_default=False)

        # Adding field 'Tag.suggested'
        db.add_column('forum_tag', 'suggested', self.gf('django.db.models.fields.related.ForeignKey')(related_name='suggest_tag', unique=True, null=True, to=orm['forum.Action']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TagRevision.suggested'
        db.delete_column('forum_tagrevision', 'suggested')

        # Deleting field 'TagRevision.suggest_status'
        db.delete_column('forum_tagrevision', 'suggest_status')

        # Deleting field 'Tag.suggested'
        db.delete_column('forum_tag', 'suggested_id')
    ...
    models = {
        ...
        'forum.questionsubscription': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 1, 15, 0, 57, 968330)'}),
        ...
        'forum.tag': {
            ...
            'about': ('django.db.models.fields.CharField', [], {'max_length': '300', 'null': 'True'}),
        ...
        'forum.validationhash': {
            ...
            'expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 2, 15, 0, 58, 118653)'}),
