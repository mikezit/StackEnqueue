...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MarkedTag.subscribed'
        db.add_column('forum_markedtag', 'subscribed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Tag.about'
        db.add_column('forum_tag', 'about', self.gf('django.db.models.fields.CharField')(max_length=300, null=True), keep_default=False)

        # Adding field 'Tag.detail'
        db.add_column('forum_tag', 'detail', self.gf('django.db.models.fields.TextField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MarkedTag.subscribed'
        db.delete_column('forum_markedtag', 'subscribed')

        # Deleting field 'Tag.about'
        db.delete_column('forum_tag', 'about')

        # Deleting field 'Tag.detail'
        db.delete_column('forum_tag', 'detail')
    ...
    models = {
        ...
        'forum.questionsubscription': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 26, 20, 29, 2, 19439)'}),
        ...
        'forum.validationhash': {
            ...
            'expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 27, 20, 29, 2, 321518)'}),
