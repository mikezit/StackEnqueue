...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Action.summary'
        db.add_column('forum_action', 'summary', self.gf('forum.models.utils.PickledObjectField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Action.summary'
        db.delete_column('forum_action', 'summary')
    ...
    models = {
        ...
        'forum.questionsubscription': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 7, 15, 41, 26, 846376)'}),
        ...
        'forum.validationhash': {
            ...
            'expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 8, 15, 41, 27, 21762)'}),
