...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Node.suggested'
        db.add_column('forum_node', 'suggested', self.gf('django.db.models.fields.related.ForeignKey')(related_name='suggest_node', unique=True, null=True, to=orm['forum.Action']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Node.suggested'
        db.delete_column('forum_node', 'suggested_id')
    ...
    models = {
        ...
        'forum.questionsubscription': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 28, 16, 8, 51, 998973)'}),
        ...
        'forum.validationhash': {
            ...
            'expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 29, 16, 8, 52, 129111)'}),
