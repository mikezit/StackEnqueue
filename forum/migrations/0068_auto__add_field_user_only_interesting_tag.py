...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.only_interesting_tag'
        db.add_column('forum_user', 'only_interesting_tag',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.only_interesting_tag'
        db.delete_column('forum_user', 'only_interesting_tag')
    ...
    models = {
        ...
        'forum.questionsubscription': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 30, 0, 0)'}),
        ...
        'forum.validationhash': {
            ...
            'expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 31, 0, 0)'}),
