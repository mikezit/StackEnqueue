...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.weibo_gravatar'
        db.add_column('forum_user', 'weibo_gravatar',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'User.use_weibo_gravatar'
        db.add_column('forum_user', 'use_weibo_gravatar',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.weibo_gravatar'
        db.delete_column('forum_user', 'weibo_gravatar')

        # Deleting field 'User.use_weibo_gravatar'
        db.delete_column('forum_user', 'use_weibo_gravatar')
    ...
    models = {
        ...
        'forum.user': {
            ...
            'use_weibo_gravatar': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'user_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['auth.User']", 'unique': 'True', 'primary_key': 'True'}),
            'website': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
            'weibo_gravatar': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'})
        },
        'forum.userproperty': {
