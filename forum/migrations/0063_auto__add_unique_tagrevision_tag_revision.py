...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'TagRevision', fields ['tag', 'revision']
        db.create_unique('forum_tagrevision', ['tag_id', 'revision'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'TagRevision', fields ['tag', 'revision']
        db.delete_unique('forum_tagrevision', ['tag_id', 'revision'])
    ...
    models = {
        ...
        'forum.questionsubscription': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 13, 14, 25, 30, 36934)'}),
        ...
        'forum.validationhash': {
            ...
            'expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 14, 14, 25, 30, 174205)'}),
