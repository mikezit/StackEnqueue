...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NodeRevision.suggest_status'
        db.add_column('forum_noderevision', 'suggest_status', self.gf('django.db.models.fields.CharField')(default='', max_length=16), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NodeRevision.suggest_status'
        db.delete_column('forum_noderevision', 'suggest_status')
    ...
    models = {
        ...
        'forum.questionsubscription': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 5, 23, 33, 40, 698643)'}),
        ...
        'forum.validationhash': {
            ...
            'expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 6, 23, 33, 40, 994820)'}),
