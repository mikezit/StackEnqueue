...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AuthKeyUserAssociation.weibo_uid'
        db.add_column('forum_authkeyuserassociation', 'weibo_uid',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AuthKeyUserAssociation.weibo_remind_in'
        db.add_column('forum_authkeyuserassociation', 'weibo_remind_in',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AuthKeyUserAssociation.weibo_expires_at'
        db.add_column('forum_authkeyuserassociation', 'weibo_expires_at',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AuthKeyUserAssociation.weibo_uid'
        db.delete_column('forum_authkeyuserassociation', 'weibo_uid')

        # Deleting field 'AuthKeyUserAssociation.weibo_remind_in'
        db.delete_column('forum_authkeyuserassociation', 'weibo_remind_in')

        # Deleting field 'AuthKeyUserAssociation.weibo_expires_at'
        db.delete_column('forum_authkeyuserassociation', 'weibo_expires_at')
    ...
    models = {
        ...
        'forum.authkeyuserassociation': {
            ...
            'weibo_expires_at': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
            'weibo_remind_in': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
            'weibo_uid': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'})
        },
        'forum.award': {
        ...
        'forum.questionsubscription': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 2, 0, 0)'}),
        ...
        'forum.user': {
            ...
            'only_interesting_tag': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'forum.validationhash': {
            ...
            'expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 3, 0, 0)'}),
