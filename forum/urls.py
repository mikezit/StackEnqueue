...
core_urls = (
    ...
    url(r'^%s(?P<path>.*)$' % _('forum/gravatar/'), 'django.views.static.serve', {'document_root': os.path.join(APP_PATH, 'gravatar').replace('\\', '/')}, name='uploaded_gravatar',),
    ...
    url(r'^%s(?P<path>.*)$' % _('gravatar/'), 'django.views.static.serve', {'document_root': os.path.join(APP_PATH, 'gravatar').replace('\\', '/')}, name='uploaded_file',),    
    ...
    url(r'^%s(?P<id>\d+)/%s$' % (_('revisions/'),_('tag/')), app.readers.tag_revisions, name='tag_revisions'),
    ...
    url(r'^%s(?P<tag>.*)$' % _('subscribe_tag/'), app.commands.subscribe_tag, name='subscribe'),
    url(r'^%s(?P<name>.*)/%s$' % (_('tag/'), _('subscriber-info/')), app.readers.tag_subscriber_info, name='tag_subscriber_info'),
    url(r'^%s(?P<id>\d+)/%s$' % (_('tag/'), _('info/')), app.readers.tag_info, name='tag_info'),
    url(r'^%s(?P<id>\d+)/%s$' % (_('tag/'), _('edit/')), app.writers.edit_tag, name='edit_tag'),    
    url(r'^%s(?P<id>\d+)/%s$' % (_('users/user/'), _('info/')), app.readers.user_info, name='user_info'),
    url(r'^%s(?P<id>\d+)/%s$' % (_('users/user/'), _('flair/')), app.readers.user_flair_html, name='user_flair_html'),
    url(r'^%s(?P<name>.*)/(?P<id>\d+)/%s$' % (_('users/'), _('flair/')), app.readers.user_flair, name='user_flair'),
    url(r'^%s(?P<id>\d+)/%s$' % (_("posts/"),_("body/")),app.readers.post_body,name="post_body"),
    url(r'^%s(?P<id>\d+)/(?P<year>\d+)/(?P<month>\d+)/(?P<day>\d+)/$' % (_("rep/day/")) ,app.readers.user_day_rep, name='user_rep'),
    url(r'^%s(?P<id>\d+)/%s(?P<reason>.*)$' % (_('tag-suggested-edit/'), _('vote/')), app.writers.tag_suggested_edits_action, name='tag_suggested_edits_action'),
    url(r'^%s(?P<id>\d+)/%s(?P<reason>.*)$' % (_('suggested-edit/'), _('vote/')), app.writers.suggested_edits_action, name='suggested_edits_action'),
    url(r'^%s%s(?P<id>\d+)$' % (_('suggested-edits/'), _('popup/')), app.readers.suggested_edits, name='suggested_edits'),
    url(r'^%s%s(?P<id>\d+)/%s$' % (_('suggested-edits/'), _('popup/'),_('tag')), app.readers.suggested_edits_tag, name='suggested_edits_tag'),
    url(r'^%s(?P<id>\d+)/%s$' % (_('questions/'), _('edit/')), app.writers.edit_question, name='edit_question'),
    url(r'^%s(?P<id>\d+)/%s$' % (_('questions/'), _('retag/')), app.writers.retag_question, name='retag_question'),
    ...
    url(r'^%s(?P<id>\d+)/(?P<node_type>.+)$' % _('link/'), app.commands.permanent_link, name='permanent_link'),
    ...
    url(r'^%s(?P<slug>.*)$' % _('privileges/'),app.readers.privileges,name="privileges"),
    ...
    url(r'^%s/(?P<id>\d+)/$' % ('change_interestingtag_viewmode' ), app.users.change_interestingTag_viewMode, name='change_interestingTag_viewMode'),
    url(r'^%s(?P<id>\d+)/%s$' % (_('users/'), _('edit/gravatar/')), app.users.edit_gravatar, name='edit_gravatar'),
    url(r'^%s(?P<user_id>\d+)/%s(?P<original_id>\d+)/%s$' % (_('users/'),_('gravatar/'), _('crop/')), app.users.crop_gravatar, name='crop_gravatar'),
    ...
    url(r'^%s(?P<id>\d+)/(?P<slug>.*)/%s$' % (_('users/'), _('tags/')), app.users.user_tags, name='user_tags'),
    ...
    url(r'^%s%s$' %(_('weibo/'), _('signin/')), app.auth.weibo_signin, name='weibo_signin'),    
    url(r'^%s%s%s$' %(_('weibo/'), _('signin/'), _('check/')), app.auth.weibo_signin_check, name='weibo_signin_check'),    
    ...
    url(r'^%s%s$' % (_('admin/'), _('suggested_posts/')), app.admin.suggested_posts, name='admin_suggested_posts'),
