...
APP_TITLE = Setting('APP_TITLE', u'Stack Pointer: china\'s Q&A Forum', BASIC_SET, dict(
label = _("Application title"),
help_text = _("The title of your application that will show in the browsers title bar")))

APP_SHORT_NAME = Setting(u'APP_SHORT_NAME', 'StackPointer', BASIC_SET, dict(
label = _("Application short name"),
help_text = "The short name for your application that will show up in many places."))

APP_KEYWORDS = Setting('APP_KEYWORDS', u'StackPointer,forum,community', BASIC_SET, dict(
...
APP_INVATATION = Setting('APP_INVATATION', u'invatation send to user.', BASIC_SET, dict(
label = _("Application invataton"),
help_text = _("The invatation of your application"),
widget=Textarea))
...
BLOG_URL = "http://blog.stackenqueue.com"
