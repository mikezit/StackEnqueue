...
REP_TO_CREATE_POSTS = Setting('REP_TO_CREATE_POSTS', 1, MIN_REP_SET, dict(
label = _("Minimum reputation to create post"),
help_text = _("The minimum reputation an user must have to be allowed to create post.")))
...
REP_IS_NEW_USER = Setting('REP_IS_NEW_USER', 20, MIN_REP_SET, dict(
label = _("Minimum reputation is a new user"),
help_text = _("Minimum reputation is a new user.")))
