...
REP_GAIN_BY_SUGGESTION = Setting('REP_GAIN_BY_SUGGESTION', 2, REP_GAIN_SET, dict(
label = _("Rep gain by suggestion"),
help_text = _("Reputation a user gains for suggest other's post.")))
