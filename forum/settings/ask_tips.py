...
PAGES_SET = SettingSet('how_to_ask', 'Ask Tips', "Define the text in the about page. You can use markdown and some basic html tags.", 2000, True)

ASK_TIPS_PAGE_TEXT = Setting('ASK_TIPS_PAGE_TEXT',
u"""
