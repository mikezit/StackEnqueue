...
FORM_MIN_TAG_BODY = Setting('FORM_MIN_TAG_BODY', 20, FORUM_SET, dict(
label = _("Minimum number of characters for a tag wiki's content"),
help_text = _("The minimum number of characters a user must enter into the content field of a tag.")))
...
FORM_EMPTY_TAG_BODY = Setting('FORM_EMPTY_TAG_BODY', True, FORUM_SET, dict(
label = _("Empty tag content"),
help_text = _("If a tag's content can be empty."),
required=False))
