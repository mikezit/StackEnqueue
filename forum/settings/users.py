...
MIN_DISPLAY_NAME_LENGTH = Setting('MIN_DISPLAY_NAME_LENGTH', 1, USERS_SET, dict(
label = _("Minimum display name length"),
help_text = _("The minimum length (in character) of a user display name.")))
...
GRAVATAR_DEFAULT_CHOICES = (
    ...
    ('blank', _('a transparent PNG image')),
)
