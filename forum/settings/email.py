...
USE_SES = Setting('USE_SES', False, EMAIL_SET, dict(
label = _("BY AMAZON SES"),
help_text = _("user amazon ses service instade of smtp"),
required=False))

# AWS_ACCESS_KEY_ID = Setting('AWS_ACCESS_KEY_ID', '', EMAIL_SET, dict(
# label = _("AWS ACCESS KEY ID"),
# help_text = _("amazon aws key id , if you want use amazon's ses mail serivice , you should set the field"),
# required=False))

# AWS_SECRET_ACCESS_KEY = Setting('AWS_SECRET_ACCESS_KEY', '', EMAIL_SET, dict(
# label = _("AWS SECRET ACCESS KEY"),
# help_text = _("amazon aws accesss key, if you want use amazon's ses mail serivice , you should set the field"),
# required=False))
